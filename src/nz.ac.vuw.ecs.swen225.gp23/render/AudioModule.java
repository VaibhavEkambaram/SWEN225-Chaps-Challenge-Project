...
public class AudioModule {
   ...
   *
   * @param clip      Clip to play sound track on loop in
   * @param audioFile Name of audio file to play
   * @author Cameron Li - 300490702
   */
  public static void playSoundTrack(Clip clip, String audioFile) {
    try {
      ...
      AudioInputStream inputStream =
          AudioSystem.getAudioInputStream(Main.class.getResourceAsStream(audioFile));
   ...
   * Loops.
   *
   * @param clip Clip to play sound in loop
   * @author Cameron Li - 300490702
   */
  ...
  /**
   * Reset the sound track of the specified clip.
  ...
  /**
   * Reset the sound track of the specific clip.
   * Does not play anything anymore.
   *
   * @param clip Clip to reset current audio to beginning
   * @author Cameron Li - 300490702
   */
